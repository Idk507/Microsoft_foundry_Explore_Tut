...
agent_name = "MS-Learn-Path-Builder"
...
agent = await project_client.agents.create_version(
    ...
    definition=PromptAgentDefinition(
        ...
        "You will be provided with input from a topic generator agent regarding specific topics the user is interested in." \
        "Based on this input, your task is to query the Microsoft Learn MCP server to find appropriate learning paths, modules, and documentation that align with the user's interests." \
        "You should utilize the MCP tool to perform searches and retrieve information from the Microsoft Learn platform." \
        "Once you have gathered the necessary information, compile a comprehensive learning path that includes links to relevant resources, a brief description of each resource, and how they fit into the overall learning journey for the user." \
        "Ensure that the learning path is structured in a logical order, starting from foundational concepts and progressing to more advanced topics." \
        "Your response should be clear, concise, and tailored to the user's specified topics.",
        tools = [tool]
    ),
)
...
public_agent_card = AgentCard(
    ...
    description = "This agent builds personalized learning paths using Microsoft Learn resources based on user-defined topics, leveraging the MS Learn MCP Server",
